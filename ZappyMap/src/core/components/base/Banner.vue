...
useHead(() => ({
  link: props.content?.imageSm ? [
    {
      rel: 'preload',
      as: 'image',
      href: props.content.imageSm,
    ...
    },
    {
      rel: 'preload',
      as: 'image',
      href: props.content.imageMd || props.content.imageSm,
  ...
  <div
    ...
    <slot name="imagebanner" v-if="props.content.imageSm">
      <div class="w-full h-1/2 md:h-full md:flex-1">
        <picture>
          <source :srcset="props.content.imageMd || props.content.imageSm" media="(min-width: 768px)" />
          <img :src="props.content.imageSm" alt="banner promocional" loading="eager" fetchpriority="high"
            class="w-full h-full object-cover" />
        </picture>
      </div>
    </slot>
    <div class="w-full h-1/2 md:h-full md:flex-1 grid place-content-center p-6 text-center">
