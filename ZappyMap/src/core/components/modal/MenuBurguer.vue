...
import { House ,Utensils} from 'lucide-vue-next';
...
const customClassRouterLink=ref("text-slate-900 text-xl flex flex-row items-center gap-1 cursor-pointer");
...
<template>
    ...
    <Teleport to="body">
        <Transition>
            <div class="fixed top-0 block md:hidden bg-ghost w-3/4 h-screen" v-if="isOpen">
