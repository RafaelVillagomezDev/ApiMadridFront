    ...
    <div
        ...
        <div class="max-w-md w-full space-y-8 text-center">
            <div class="mb-8">
                ...
                <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-gray-100">Página no encontrada</p>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Disculpa , no hemos podido encontrar la página que estabas buscando. Es posible que haya sido movida o eliminada.
                </p>
            </div>
            <div class="mt-8">
                <a href="/"
            ...
            <div class="relative">
                ...
                <div class="relative flex justify-center">
                    <span class="px-2 bg-gray-100 dark:bg-gray-800 text-sm text-gray-500 dark:text-gray-400">
                        Si crees que esto es un error, por favor contáctanos para que podamos solucionarlo.
                    </span>
                </div>
            </div>
        </div>
